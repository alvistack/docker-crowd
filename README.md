...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/crowd-7.0.svg)](https://hub.docker.com/r/alvistack/crowd-7.0)
...
- [`alvistack/crowd-7.0`](https://hub.docker.com/r/alvistack/crowd-7.0)
  - [`packer/docker-7.0/packer.json`](https://github.com/alvistack/docker-crowd/blob/master/packer/docker-7.0/packer.json)
...
Start Atlassian Crowd Server:
    ...
    # Pull latest image
    docker pull alvistack/crowd-7.0
