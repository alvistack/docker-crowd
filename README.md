...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/crowd-7.2.svg)](https://hub.docker.com/r/alvistack/crowd-7.2)
...
- [`alvistack/crowd-7.2`](https://hub.docker.com/r/alvistack/crowd-7.2)
  - [`packer/docker-7.2/packer.json`](https://github.com/alvistack/docker-crowd/blob/master/packer/docker-7.2/packer.json)
...
Start Atlassian Crowd Server:
    ...
    # Pull latest image
    docker pull alvistack/crowd-7.2
